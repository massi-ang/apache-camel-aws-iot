...
public class IotComponentVerifierExtension extends DefaultComponentVerifierExtension {

    public IotComponentVerifierExtension() {
        this("aws-iot-data");
    }

    public IotComponentVerifierExtension(String scheme) {
        super(scheme);
    }
